        ...
        <div class="input_box">
            <div class="center_boxs_form">
                <form action="MainServlet" >
                    ...
                    <input type="text" class="input_Dimention_box" name="latitude" placeholder="Kinh Độ" required="true"/><br/>
                    ...
                    <div class = "combobox">
                        <span class="span">Ưu Tiên Số 1</span><select name="first">
                    ...
                    <div class = "combobox">
                        <span class="span">Ưu Tiên Số 2</span><select name="second">
